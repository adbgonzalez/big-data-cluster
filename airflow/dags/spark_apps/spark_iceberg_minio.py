...
TABLE = "minio.demo_airflow.people"


def main() -> None:
    spark = SparkSession.builder.appName("airflow-spark-iceberg-demo").getOrCreate()

    spark.sql("CREATE NAMESPACE IF NOT EXISTS minio.demo_airflow")
    ...
    print(f"ICEBERG_MINIO_COUNT={count}")
